    <div class="recuadrado">
        {if $viaje == "Roma"}
            <h3><span>Distancia recorrida: </span><span>36 km</span></h3>
        ...
        {else if $viaje == "Barcelona"}
            <h3><span>Distancia recorrida: </span><span>0 km</span></h3>
        ...
        {else if $viaje == "Madrid"}
            <h3><span>Distancia recorrida: </span><span>21 km</span></h3>
